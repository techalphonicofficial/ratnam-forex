...
export default function BookingSidebar({ tour }) {
  ...
  return (
    <div className="booking-sidebar">
      ...
      <button className="btn-primary w-100 book-now-leaf" style={{ justifyContent: 'center', marginBottom: 'var(--space-3)', background: '#FF6600', borderColor: '#FF6600', color: 'white' }}>
        Book Now 
