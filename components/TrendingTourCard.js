      ...
      <div className="ttc-body">
        ...
        <div className="ttc-footer">
          ...
          <button className="ttc-btn">
            View Details
            <svg className="ttc-btn-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
