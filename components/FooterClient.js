      ...
      <div className="section-sm">
        <div className="container">
          <div className="d-flex justify-content-center mb-4 pb-3">
            <Image src={brandLogo} alt={`${brandName} Logo`} width={160} height={60} style={{ width: 'auto', height: 60, objectFit: 'contain' }} />
          </div>
          <div className="row gy-4 gy-lg-5 gx-lg-5 text-center">
            <div className="col-12 col-lg-4 d-flex flex-column align-items-center">
              <p style={{ color: 'var(--color-text-secondary)', fontSize: 15, lineHeight: 1.8, maxWidth: 320, marginBottom: 24 }}>
                {brandDescription}
              </p>

              <div className="d-flex flex-column gap-2 mb-4">
                {phone && (
                  <a href={`tel:${phone}`} className="d-flex align-items-center justify-content-center gap-2" style={{ color: 'var(--color-text-secondary)', fontSize: 14, textDecoration: 'none' }}>
                    <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
                ...
                {email && (
                  <a href={`mailto:${email}`} className="d-flex align-items-center justify-content-center gap-2" style={{ color: 'var(--color-text-secondary)', fontSize: 14, textDecoration: 'none' }}>
                    <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
      ...
      <div style={{ borderTop: '1px solid #e5e7eb' }}>
        <div className="container">
          <div className="py-4 d-flex flex-column flex-md-row align-items-center justify-content-between gap-4 text-center text-md-start">
            ...
            <div style={{ flex: 1 }}>
              <p style={{ color: 'var(--color-text-muted)', fontSize: 13, margin: 0, whiteSpace: 'pre-line' }}>
                {footerContent}
              </p>
            </div>

            <div className="d-flex flex-wrap justify-content-center justify-content-md-end gap-3 gap-md-4" style={{ flex: 1 }}>
