          ...
          {[0, 3, 3.5, 4, 4.5].map((r) => (
            <button
              ...
              style={{
                ...
                fontWeight: 600,
                border: '1.5px solid',
                borderColor: filters.minRating === r ? '#8EB69B' : 'var(--color-border)',
                background: filters.minRating === r ? '#8EB69B' : 'transparent',
                color: filters.minRating === r ? '#FFFFFF' : 'var(--color-text-muted)',
                cursor: 'pointer',
                transition: 'all 0.2s',
              }}
            >
