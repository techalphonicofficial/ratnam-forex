...
const PIPELINE_FORM_ENDPOINT = 'http://localhost:3011/api/v1/crm/pipelines/3/form';
const COMPANY_INFO_ENDPOINT = 'http://localhost:3011/api/v1/crm/settings/company-info';
